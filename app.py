...
# Creiamo un repository git con il comando "git init"
# Vedi comandi "git add", "git commit"

st.write("""
# Emissioni inquinanti in Europastr
""")

url = "https://ec.europa.eu/eurostat/api/dissemination/sdmx/2.1/data/sdg_13_10?format=TSV&compressed=true"

# La funzone "write" di streamlit ci consente di inserire
# delle stringhe formattate in Markdown. 
...
# il comando "select_slider" permette di aggiungere uno slider 
# per la selezione dell'anno.
